...
> 🦉 NOTE: Because we're easing you into React by using the `index.html` and
> UMDs with unpkg.com URLs, you're going to see an error in the console that
> looks like this:
>
> ```
...
> ```
>
> The error is not really problematic for our purposes and will go away when we
> move on from the `index.html` soon. For more info, reference:
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=siegblink%40gmail.com).
